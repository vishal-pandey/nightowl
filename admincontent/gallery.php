...
<script type="text/javascript">
	$(document).ready(function(){
	    ...
	    $("button#add-season").click(function(){
			$.post("./post/gallery/add-season.php", function(data, status){
	     ...
	     $("button#edit-season").click(function(){
			$.post("./post/gallery/edit-season.php", function(data, status){
		...
		function bindSubmit(){
			$('.add-season-content').ready(function(){
				$(".add-season-form").submit(function(e) {
				    var url = "./post/gallery/add-season-control.php";
				    $.ajax({
				           type: "POST",
				           url: url,
				           data: $(this).serialize(), 
