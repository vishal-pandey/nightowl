...
<script type="text/javascript">
	$(document).ready(function(){
	    ...
	    $("button#add-season").click(function(){
			$.post("./post/exhibitor/add-season.php", function(data, status){
	     ...
	     $("button#edit-season").click(function(){
			$.post("./post/exhibitor/edit-season.php", function(data, status){
		...
		function bindSubmit(){
			$('.add-season-content').ready(function(){
				$(".add-season-form").submit(function(e) {
				    var url = "./post/exhibitor/add-season-control.php";
				    $.ajax({
				           type: "POST",
				           url: url,
				           data: $(this).serialize(), 
