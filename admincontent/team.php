	...
	<div class="instruction">
		...
		<p>
			<ol>
				...
				<li>Upload caption of the image as name of the image.</li>
			</ol>
		</p>
	</div>
...
<script type="text/javascript">
	$(document).ready(function(){
	    ...
	    $("button#add-season").click(function(){
			$.post("./post/team/add-season.php", function(data, status){
	     ...
	     $("button#edit-season").click(function(){
			$.post("./post/team/edit-season.php", function(data, status){
		...
		function bindSubmit(){
			$('.add-season-content').ready(function(){
				$(".add-season-form").submit(function(e) {
				    var url = "./post/team/add-season-control.php";
				    $.ajax({
				           type: "POST",
				           url: url,
				           data: $(this).serialize(), 
