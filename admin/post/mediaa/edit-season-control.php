...
?>
	...
	<form method="post" enctype="multipart/form-data" class="well file-upload-form">
		<div class="inputfiles">
			...
			<input type="text" name="dir" value="<?php echo '../../../images/media/'.$season.'/'; ?>" hidden="true">
...
<script type="text/javascript">
	...
	$(".file-upload-form").submit(function(e) {
	    var url = "./post/mediaa/upload.php";
	    ...
	    $.ajax({
         ...
         processData: false,
	           ...
	           {
	           		if (data=="success") {
	           			$url1 = "./post/mediaa/edit-season-control.php";
	...
	$(".img-delete").click(function(){
		if (confirm("Do you want to delete this image")) {
			...
			$url3 = './post/mediaa/imgdelete.php';
			$.post($url3,
		    {
		        img: imglink,
		   },
