...
<?php
	...
	// readdir("../../../images/exhibitor/".$season);
?>
	...
	<form method="post" enctype="multipart/form-data" class="well file-upload-form">
		<div class="inputfiles">
			...
			<input type="text" name="dir" value="<?php echo '../../../images/exhibitor/'.$season.'/'; ?>" hidden="true">
...
<script type="text/javascript">
	...
	$(".file-upload-form").submit(function(e) {
	    var url = "./post/exhibitor/upload.php";
	...
	$(".img-delete").click(function(){
		if (confirm("Do you want to delete this image")) {
			...
			$url3 = './post/exhibitor/imgdelete.php';
			$.post($url3,
		    {
		        img: imglink,
		   },
